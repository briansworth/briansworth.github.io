...
```
You could make this much more versatile by adding support for more encoding options like ASCII, but this is a start ([I added this functionality here]({{ site.baseurl }}/Decode-Encode-Base64-pt2/)).
